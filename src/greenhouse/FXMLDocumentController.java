...
public class FXMLDocumentController implements Initializable, Runnable{
    ...
    private void openWindows(){
        ...
        Platform.runLater(() -> { 
         ...
         b_windows.setStyle("-fx-background-color: #558B2F; -fx-text-fill: #FFFFFF; ");
    ...
    private void closeWindows(){
        ...
        Platform.runLater(() -> { 
          ...
          b_windows.setStyle("-fx-background-color: #37474F; -fx-text-fill: #FFFFFF; ");
    ...
    private void onShower(){
        ...
        Platform.runLater(() -> { 
          ...
          b_shower.setStyle("-fx-background-color: #558B2F; -fx-text-fill: #FFFFFF; ");
    ...
    private void offShower(){
        ...
        Platform.runLater(() -> { 
         ...
         b_shower.setStyle("-fx-background-color: #37474F; -fx-text-fill: #FFFFFF; ");
